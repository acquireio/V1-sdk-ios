...
- (void)growingTextViewDidSelectAutoSuggetionMessage:(HPGrowingTextView *)growingTextView;
@end

@interface HPGrowingTextView : UIView <UITextViewDelegate, UITextViewAutoSuggestionDataSource> {
...
@property (nonatomic, strong) NSMutableArray *autoSuggestData;
//uitextview properties
